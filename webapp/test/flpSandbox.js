		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Training with SOH &amp; IFL",
									"targetURL": "#trainingtrain01-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"trainingtrain01-display": {
								"semanticObject": "trainingtrain01",
								"action": "display",
								"description": "Training with SOH &amp; IFL",
								"title": "Training with SOH &amp; IFL",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=training.train01",
									"url": sap.ui.require.toUrl("training/train01")
								}
							}
						}
					}
